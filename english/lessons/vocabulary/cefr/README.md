...
Bộ vocabulary được chia theo level CEFR và học theo chủ đề. Mỗi file là một bài hoàn chỉnh, không có giới hạn cứng về số lượng từ; file chỉ nên gom đủ từ/cụm từ cần thiết để khai thác trọn một chủ đề hoặc tình huống, tránh tách một chủ đề thành quá nhiều file nhỏ.
