...
- C1: 0 items.
- C2: 2035 items in 102 topic files, including the public-accountability and rhetoric expansions.
- C2+: 0 items.
- Total: 4799 items.
...
Next lesson: create `c2/rhetoric/101-...md` or choose the next coherent C2 topic; continue folder-local numbering from the latest completed lesson.
...
- Actual counts: A1 400, A2 1501, B1 848, B2 15, C1 0, C2 2035, C2+ 0; total 4799.
- Intentional repeated headword: `staging` appears with distinct medical (disease extent) and aerospace (rocket-stage separation) senses; no known vocabulary blocker in this batch.
