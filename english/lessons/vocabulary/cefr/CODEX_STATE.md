...
- A2: lessons `01`–`15`, 245 items; continue with A2 lesson `16`.
- B1: 0 items.
...
- A2 lesson 15 (`learning languages`) is validated and committed.
- Next lesson: `english/lessons/vocabulary/cefr/a2/16-...md`.
- No known vocabulary blocker.
