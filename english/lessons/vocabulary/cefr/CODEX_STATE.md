...
- A2: lessons `01`–`27`, 425 items; continue with A2 lesson `28`.
- B1: 0 items.
...
- A2 lessons 25–27 (`shopping choices and value`, `digital work and files`, and `nature and landscapes`) are validated and ready to commit.
- Next lesson: `english/lessons/vocabulary/cefr/a2/28-...md`.
- Actual counts: A1 400, A2 425, B1 0, B2 15, C1 0, C2 15, C2+ 0; total 855.
