...
- A2: lessons `01`–`61`, 935 items; continue with A2 lesson `62`.
- B1: 0 items.
...
- A2 lessons 59–61 (`sports and exercise`, `food ingredients`, and `physical descriptions`) are validated and ready to commit.
- Next lesson: `english/lessons/vocabulary/cefr/a2/62-...md`.
- Actual counts: A1 400, A2 935, B1 0, B2 15, C1 0, C2 15, C2+ 0; total 1365.
