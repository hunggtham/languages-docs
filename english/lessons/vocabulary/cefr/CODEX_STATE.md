...
- A2: lessons `01`–`67`, 1025 items; continue with A2 lesson `68`.
- B1: 0 items.
...
- A2 lessons 65–67 (`education life`, `city landmarks`, and `kitchen equipment`) are validated and ready to commit.
- Next lesson: `english/lessons/vocabulary/cefr/a2/68-...md`.
- Actual counts: A1 400, A2 1025, B1 0, B2 15, C1 0, C2 15, C2+ 0; total 1455.
