...
- A2: lessons `01`–`28`, 440 items; continue with A2 lesson `29`.
- B1: 0 items.
...
- A2 lesson 28 (`health problems and care`) is validated and ready to commit as a single-lesson checkpoint before continuing the next batch.
- Next lesson: `english/lessons/vocabulary/cefr/a2/29-...md`.
- Actual counts: A1 400, A2 440, B1 0, B2 15, C1 0, C2 15, C2+ 0; total 870.
