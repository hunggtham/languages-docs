...
- A2: 45 topic files covering source lessons `01`–`81` plus the new expansion batches, 1417 items; topic-folder numbering resets per folder.
- B1: 0 items.
...
- A2 expansion batches added 175 new items across office administration, careers and services, camping equipment, mail and parcel delivery, store shopping, travel arrangements, phone communication, laundry care, doctor visits, daily routines, and film/performance vocabulary; the latest 18-item and 22-item files use topic-sized review contexts and are validated.
- Next file: `english/lessons/vocabulary/cefr/a2/communication/05-...md`, `health/03-...md`, `time/03-...md`, or the next number in another selected topic folder; a new topic starts at `01`.
- Actual counts: A1 400, A2 1417, B1 0, B2 15, C1 0, C2 15, C2+ 0; total 1847.
