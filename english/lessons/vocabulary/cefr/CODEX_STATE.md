...
- B1: 428 items in 21 topic files; topic-folder numbering resets per folder.
...
- A2 reached its soft planning target at 1,501 items. The current expansion has added validated B1 technology, community/social-challenges, heritage/museums, data/digital-work, management/leadership, finance/economy, law/public-services, learning/assessment, healthcare/prevention, digital-communication, research/innovation, workplace-wellbeing, and travel-planning topics.
- Next file: continue the corpus expansion with the next coherent B1 topic or folder-local sequence.
- Actual counts: A1 400, A2 1501, B1 428, B2 15, C1 0, C2 15, C2+ 0; total 2359.
