...
- A2: lessons `01`–`64`, 980 items; continue with A2 lesson `65`.
- B1: 0 items.
...
- A2 lessons 62–64 (`gardening and plants`, `directions and position`, and `nuanced emotions`) are validated and ready to commit.
- Next lesson: `english/lessons/vocabulary/cefr/a2/65-...md`.
- Actual counts: A1 400, A2 980, B1 0, B2 15, C1 0, C2 15, C2+ 0; total 1410.
