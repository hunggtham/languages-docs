...
- A2: lessons `01`–`76`, 1160 items; continue with A2 lesson `77`.
- B1: 0 items.
...
- A2 lessons 74–76 (`practical actions`, `city travel`, and `people and jobs`) are validated and ready to commit.
- Next lesson: `english/lessons/vocabulary/cefr/a2/77-...md`.
- Actual counts: A1 400, A2 1160, B1 0, B2 15, C1 0, C2 15, C2+ 0; total 1590.
