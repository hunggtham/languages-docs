...
- A1 core topics 01–20 are now complete for this curriculum pass; the next level to generate is A2.
- A2 lessons `01`–`12` are now generated and validated; continue with A2 lesson `13`.
